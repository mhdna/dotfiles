...
vim.keymap.set('n', 'Q', 'gq', bufopts)
vim.keymap.set('n', '<leader>s', ':setlocal spell! spelllang=en_us<CR>', bufopts)
vim.keymap.set('n', '<leader>F', 'gg=G<C-o>', bufopts)
...
vim.keymap.set('n', '<leader>x', "<cmd>w<CR><cmd>so %<CR>", bufopts)
