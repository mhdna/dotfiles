...
REDIRECT_MAP = {
	...
	"www.instagram.com": operator.methodcaller('setHost', 'bibliogram.1d4.us'),
	"instagram.com": operator.methodcaller('setHost', 'bibliogram.1d4.us'),
	"www.reddit.com": operator.methodcaller('setHost', 'old.reddit.com'),
	# "youtube.com": operator.methodcaller('setHost', 'invidious.namazso.eu'),
    # "https://www.youtube.com": operator.methodcaller('setHost', 'invidious.namazso.eu'),
	"twitter.com": operator.methodcaller('setHost', 'nitter.42l.fr'),
	"www.twitter.com": operator.methodcaller('setHost', 'nitter.kavin.rocks'),
