...
config.set('url.searchengines', {"DEFAULT": "https://searx.be/?q={}", "s": "https://www.startpage.com/do/search?q={}", "w": "https://wiby.me/?q={}", "S": "https://www.searx.be/search?q={}", "aw": "https://wiki.archlinux.org/?search={}", "wi": "https://en.wikipedia.org/wiki/Special:Search/{}", "dic": "https://www.urbandictionary.com/define.php?term=%7B{}%7D", "y": "invidious.namazso.eu/search?q={}","yt": "https://www.youtube.com/results?search_query={}", "yy": "https://yandex.com/images/search?text={}"  })
...
# print
config.bind('<Ctrl+Alt+p>',"print --pdf ~/dox/readlater/{title}.pdf ;; spawn notify-send -t 1500 'printing'")
config.bind('<Ctrl+Alt+r>',"spawn bach -c 'echo {url}{title} >> ~/dox/notes/todo.txt && notify-send -t 1500 'Read Later''")
# clipboard
...
# yank phone
config.bind('yp', 'spawn kdeconnect-cli --refresh && kdeconnect-cli --share-text {url} --device 415a811582e4a899')
...
c.aliases['ytaa'] = """spawn -v -m bash -c 'cd ~/music/yt && youtube-dl -x -f bestaudio/best "$@"' _ {url}"""
